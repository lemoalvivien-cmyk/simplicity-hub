...
const founderFeatures = [
  {
    icon: Mic,
    color: "hsl(210 85% 62%)",
    category: "Prospection IA vocale",
    items: [
      "ADA prospecte en voix ElevenLabs · 24/7 · sans supervision",
      "Swarm multi-agents autonome — exécution continue",
      "Scripts adaptatifs par secteur & persona",
      "Consentement RGPD enregistré automatiquement",
    ],
  },
  {
    icon: Bot,
    color: "hsl(var(--primary-glow))",
    category: "Closing & pipeline",
    items: [
      "Négociation IA haute performance (Llama-3-70B)",
      "OpenClaw apporte des affaires en autonomie",
      "Deal Radar — signaux d'intention temps réel",
      "Cockpit de suivi · Human-in-the-loop validé",
    ],
  },
  {
    icon: Coins,
    color: "hsl(var(--accent))",
    category: "Royalties & WMAX Token",
    items: [
      "12 % royalty tokenisée sur chaque deal fermé",
      "7 % platform fee + 5 % engine fee swarm",
      "WMAX token sur Base L2 — revendable sur secondary market",
      "Mint automatique à chaque deal · Traçabilité blockchain",
    ],
  },
  {
    icon: TrendingUp,
    color: "hsl(152 62% 52%)",
    category: "Data & cash flow",
    items: [
      "Live Cash Flow connecté via PSD2",
      "Eternal Trust Graph v2 — pgvector + shortest_path",
      "Scoring IA des leads · Attribution prouvée on-chain",
      "Insights API — accès données institutionnelles",
    ],
  },
  {
    icon: Shield,
    ...
    items: [
      ...
      "Introductions tracées & validées cryptographiquement",
      "Protection anti-contournement · Audit log complet",
      "Support inclus · Mises à jour incluses · RGPD",
    ],
  },
];
