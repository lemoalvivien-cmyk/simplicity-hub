  ...
  return (
    <AdminLayout title="Paiements" subtitle="Abonnements Stripe + accès promo — données réelles">
            ...
            {rows.length === 0 && (
              <div className="py-12 text-center">
                <p className="text-muted-foreground text-sm">
                  Aucune entrée — base vide ou accès insuffisant.
                </p>
      ...
      <p className="text-xs text-muted-foreground mt-4 text-center">
        ...
        Montants Stripe en temps réel disponibles après configuration du webhook Stripe (secret <code>STRIPE_WEBHOOK_SECRET</code>).
      </p>
    </AdminLayout>
  );
}
