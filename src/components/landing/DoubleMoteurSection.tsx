      ...
      <div className="container max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="rounded-2xl overflow-hidden border border-border" style={{
            background: "linear-gradient(160deg, hsl(218 65% 9%), hsl(218 55% 12%))"
          }}>
            <div className="px-6 pt-6 pb-4 border-b" style={{ borderColor: "hsl(218 40% 22% / 0.6)" }}>
                ...
                {moteur1Features.map(({ icon: Icon, label }) => (
                  <li key={label} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-lg flex items-center justify-center shrink-0"
                      ...
                      <Icon size={12} style={{ color: "hsl(218 72% 65%)" }} />
                    </div>
                    <span className="text-sm text-white/75">{label}</span>
                  </li>
                ))}
              </ul>
              <div className="mt-5 flex items-center gap-2 px-3 py-2.5 rounded-xl" style={{
                background: "hsl(218 72% 18% / 0.4)",
                border: "1px solid hsl(218 40% 30% / 0.3)"
              }}>
                <Zap size={12} style={{ color: "hsl(218 72% 65%)" }} />
          ...
          <div className="rounded-2xl overflow-hidden border border-border" style={{
            background: "linear-gradient(160deg, hsl(24 60% 8%), hsl(38 50% 11%))"
          }}>
            <div className="px-6 pt-6 pb-4 border-b" style={{ borderColor: "hsl(24 50% 20% / 0.6)" }}>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
            ...
            <div className="p-6">
                ...
                {moteur2Features.map(({ icon: Icon, label }) => (
                  <li key={label} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-lg flex items-center justify-center shrink-0"
                      ...
                      <Icon size={12} style={{ color: "hsl(24 100% 65%)" }} />
                    </div>
                    <span className="text-sm text-white/75">{label}</span>
                  </li>
                ))}
              ...
              <div className="mt-5 flex items-center gap-2 px-3 py-2.5 rounded-xl" style={{
                ...
                <Shield size={12} style={{ color: "hsl(24 100% 65%)" }} />
                <p className="text-xs text-white/50">
                  Chaque introduction est <span className="text-white/80 font-semibold">protégée et prouvable</span>.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Pont entre les deux */}
        <div className="mt-6 rounded-2xl p-5 text-center border" style={{
