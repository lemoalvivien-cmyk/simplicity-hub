      ...
      <div className="container max-w-4xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-2.5">
              {[
                ...
                <div key={item} className="flex items-start gap-2.5">
                  <CheckCircle2 size={15} style={{ color: "hsl(var(--primary))" }} className="shrink-0 mt-0.5" />
          ...
          <div className="rounded-2xl overflow-hidden border" style={{
            ...
            <div className="flex items-center gap-3 px-5 py-4 border-b" style={{ borderColor: "hsl(218 40% 20% / 0.5)" }}>
            ...
            <div className="p-5 space-y-3">
              {features.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="flex items-start gap-3 p-3 rounded-xl" style={{
                  ...
                  <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0" style={{
                    ...
                    <Icon size={13} style={{ color: "hsl(218 72% 65%)" }} />
                  </div>
            ...
            <div className="px-5 pb-5">
              <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl" style={{
                ...
                <p className="text-xs text-white/50">
                  <span className="font-semibold text-white/80">Vos agents travaillent</span> pendant que votre réseau diffuse.
                </p>
              </div>
            </div>
          </div>
